...
#ifdef CMAKE
#define AMCL_VERSION_MAJOR 4 /**< Major version of the library */
#define AMCL_VERSION_MINOR 12 /**< Minor version of the library */
#define AMCL_VERSION_PATCH 3 /**< Patch version of the library */
 ...
 *
	...
	@param k the AES key as an array of 16 bytes
	@param n the number of bytes in the Initialization Vector (IV)
	@param iv the IV
 */

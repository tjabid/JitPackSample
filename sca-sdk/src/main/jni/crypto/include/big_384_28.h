...
#include "arch.h"
#include "amcl.h"
#include "config_big_384_28.h"

//#define UNWOUND

#define BIGBITS_384_28 (8*MODBYTES_384_28) /**< Length in bits */
#define NLEN_384_28 (1+((8*MODBYTES_384_28-1)/BASEBITS_384_28)) /**< length in bytes */
#define DNLEN_384_28 2*NLEN_384_28 /**< Double length in bytes */
#define BMASK_384_28 (((chunk)1<<BASEBITS_384_28)-1) /**< Mask = 2^BASEBITS-1 */
#define NEXCESS_384_28 (1<<(CHUNK-BASEBITS_384_28-1))           /**< 2^(CHUNK-BASEBITS-1) - digit cannot be multiplied by more than this before normalisation */

#define HBITS_384_28 (BASEBITS_384_28/2)      /**< Number of bits in number base divided by 2 */
#define HMASK_384_28 (((chunk)1<<HBITS_384_28)-1)    /**< Mask = 2^HBITS-1 */

//#define DEBUG_NORM

#ifdef DEBUG_NORM  /* Add an extra location to track chunk extension */
#define MPV_384_28 NLEN_384_28
#define MNV_384_28 (NLEN_384_28+1)
typedef chunk BIG_384_28[NLEN_384_28+2];   /**< Define type BIG as array of chunks */
#define DMPV_384_28 DNLEN_384_28
#define DMNV_384_28 (DNLEN_384_28+1)
typedef chunk DBIG_384_28[DNLEN_384_28+2]; /**< Define type DBIG as array of chunks */
#else
typedef chunk BIG_384_28[NLEN_384_28];     /**< Define type BIG as array of chunks */
typedef chunk DBIG_384_28[DNLEN_384_28];   /**< Define type DBIG as array of chunks */
#endif
 ...
 */
extern void BIG_384_28_cswap(BIG_384_28 x,BIG_384_28 y,int s);
 ...
 */
extern void BIG_384_28_cmove(BIG_384_28 x,BIG_384_28 y,int s);
 ...
 *
	...
	@param s copy takes place if not equal to 0
 */
extern void BIG_384_28_dcmove(BIG_384_28 x,BIG_384_28 y,int s);
/**	@brief Convert from BIG number to byte array
 *
	@param a byte array
	@param x BIG number
 */
extern void BIG_384_28_toBytes(char *a,BIG_384_28 x);
/**	@brief Convert to BIG number from byte array
 *
	@param x BIG number
	@param a byte array
 */
extern void BIG_384_28_fromBytes(BIG_384_28 x,char *a);
 ...
 */
extern void BIG_384_28_fromBytesLen(BIG_384_28 x,char *a,int s);
 ...
 *
   ...
   @param s byte array length
 */
extern void BIG_384_28_dfromBytesLen(DBIG_384_28 x,char *a,int s);
/**	@brief Outputs a DBIG number to the console
 *
	@param x a DBIG number
 */
extern void BIG_384_28_doutput(DBIG_384_28 x);

/**	@brief Outputs a DBIG number to the console
 *
	@param x a DBIG number
 */
extern void BIG_384_28_drawoutput(DBIG_384_28 x);
 ...
 */
extern void BIG_384_28_rcopy(BIG_384_28 x,const BIG_384_28 y);
/**	@brief Copy BIG to another BIG
 *
	@param x BIG number
	@param y BIG number to be copied
 */
extern void BIG_384_28_copy(BIG_384_28 x,BIG_384_28 y);
/**	@brief Copy DBIG to another DBIG
 *
	@param x DBIG number
	@param y DBIG number to be copied
 */
extern void BIG_384_28_dcopy(DBIG_384_28 x,DBIG_384_28 y);
/**	@brief Copy BIG to upper half of DBIG
 *
	@param x DBIG number
	@param y BIG number to be copied
 */
extern void BIG_384_28_dsucopy(DBIG_384_28 x,BIG_384_28 y);
/**	@brief Copy BIG to lower half of DBIG
 *
	@param x DBIG number
	@param y BIG number to be copied
 */
extern void BIG_384_28_dscopy(DBIG_384_28 x,BIG_384_28 y);
/**	@brief Copy lower half of DBIG to a BIG
 *
	@param x BIG number
	@param y DBIG number to be copied
 */
extern void BIG_384_28_sdcopy(BIG_384_28 x,DBIG_384_28 y);
/**	@brief Copy upper half of DBIG to a BIG
 *
	@param x BIG number
	@param y DBIG number to be copied
 */
extern void BIG_384_28_sducopy(BIG_384_28 x,DBIG_384_28 y);
/**	@brief Set BIG to zero
 *
	@param x BIG number to be set to zero
 */
extern void BIG_384_28_zero(BIG_384_28 x);
/**	@brief Set DBIG to zero
 *
	@param x DBIG number to be set to zero
 */
extern void BIG_384_28_dzero(DBIG_384_28 x);
/**	@brief Set BIG to one (unity)
 *
	@param x BIG number to be set to one.
 */
extern void BIG_384_28_one(BIG_384_28 x);
/**	@brief Set BIG to inverse mod 2^256
 *
	@param x BIG number to be inverted
 */
extern void BIG_384_28_invmod2m(BIG_384_28 x);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_384_28_add(BIG_384_28 x,BIG_384_28 y,BIG_384_28 z);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_384_28_or(BIG_384_28 x,BIG_384_28 y,BIG_384_28 z);
 ...
 *
	...
	@param i integer
 */
extern void BIG_384_28_inc(BIG_384_28 x,int i);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_384_28_sub(BIG_384_28 x,BIG_384_28 y,BIG_384_28 z);
/**	@brief Decrement BIG by a small integer - output not normalised
 *
	@param x BIG number to be decremented
	@param i integer
 */
extern void BIG_384_28_dec(BIG_384_28 x,int i);
 ...
 *
	...
	@param z DBIG number
 */
extern void BIG_384_28_dadd(DBIG_384_28 x,DBIG_384_28 y,DBIG_384_28 z);
 ...
 *
	...
	@param z DBIG number
 */
extern void BIG_384_28_dsub(DBIG_384_28 x,DBIG_384_28 y,DBIG_384_28 z);
 ...
 */
extern void BIG_384_28_imul(BIG_384_28 x,BIG_384_28 y,int i);
 ...
 */
extern chunk BIG_384_28_pmul(BIG_384_28 x,BIG_384_28 y,int i);
/**	@brief Divide BIG by 3 - output normalised
 *
	@param x BIG number
	@return Remainder
 */
extern int BIG_384_28_div3(BIG_384_28 x);
 ...
 *
	...
	@param i small integer
 */
extern void BIG_384_28_pxmul(DBIG_384_28 x,BIG_384_28 y,int i);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_384_28_mul(DBIG_384_28 x,BIG_384_28 y,BIG_384_28 z);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_384_28_smul(BIG_384_28 x,BIG_384_28 y,BIG_384_28 z);
 ...
 */
extern void BIG_384_28_sqr(DBIG_384_28 x,BIG_384_28 y);
 ...
 */
extern void BIG_384_28_monty(BIG_384_28 a,BIG_384_28 md,chunk MC,DBIG_384_28 d);
 ...
 */
extern void BIG_384_28_shl(BIG_384_28 x,int s);
 ...
 */
extern int BIG_384_28_fshl(BIG_384_28 x,int s);
 ...
 *
	...
	@param s Number of bits to shift
 */
extern void BIG_384_28_dshl(DBIG_384_28 x,int s);
/**	@brief Shifts a BIG right by any number of bits - input must be normalised, output normalised
 *
	@param x BIG number to be shifted
	@param s Number of bits to shift
 */
extern void BIG_384_28_shr(BIG_384_28 x,int s);
 ...
 */
extern int BIG_384_28_fshr(BIG_384_28 x,int s);
/**	@brief Shifts a DBIG right by any number of bits - input must be normalised, output normalised
 *
	@param x DBIG number to be shifted
	@param s Number of bits to shift
 */
extern void BIG_384_28_dshr(DBIG_384_28 x,int s);
 ...
 */
extern chunk BIG_384_28_split(BIG_384_28 x,BIG_384_28 y,DBIG_384_28 z,int s);
 ...
 */
extern chunk BIG_384_28_norm(BIG_384_28 x);
 ...
 */
extern void BIG_384_28_dnorm(DBIG_384_28 x);
 ...
 */
extern int BIG_384_28_comp(BIG_384_28 x,BIG_384_28 y);
 ...
 *
	...
	@param n The modulus
 */
extern void BIG_384_28_mod(BIG_384_28 x,BIG_384_28 n);
 ...
 *
	...
	@param n The Divisor
 */
extern void BIG_384_28_sdiv(BIG_384_28 x,BIG_384_28 n);
 ...
 *
	...
	@param n Modulus
 */
extern void BIG_384_28_dmod(BIG_384_28 x,DBIG_384_28 y,BIG_384_28 n);
 ...
 *
	...
	@param n Modulus
 */
extern void BIG_384_28_ddiv(BIG_384_28 x,DBIG_384_28 y,BIG_384_28 n);
/**	@brief  return parity of BIG, that is the least significant bit
 *
	@param x BIG number
	@return 0 or 1
 */
extern int BIG_384_28_parity(BIG_384_28 x);
 ...
 *
	...
	@return 0 or 1
 */
extern int BIG_384_28_bit(BIG_384_28 x,int i);
 ...
 */
extern int BIG_384_28_lastbits(BIG_384_28 x,int n);
 ...
 */
extern void BIG_384_28_random(BIG_384_28 x,csprng *r);
 ...
 *
	...
	@param r A pointer to a Cryptographically Secure Random Number Generator
 */
extern void BIG_384_28_randomnum(BIG_384_28 x,BIG_384_28 n,csprng *r);
 ...
 */
extern void BIG_384_28_modmul(BIG_384_28 x,BIG_384_28 y,BIG_384_28 z,BIG_384_28 n);
/**	@brief  Calculate x=y/z mod n
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_384_28_moddiv(BIG_384_28 x,BIG_384_28 y,BIG_384_28 z,BIG_384_28 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_384_28_modsqr(BIG_384_28 x,BIG_384_28 y,BIG_384_28 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_384_28_modneg(BIG_384_28 x,BIG_384_28 y,BIG_384_28 n);
 ...
 */
extern int BIG_384_28_jacobi(BIG_384_28 x,BIG_384_28 y);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_384_28_invmodp(BIG_384_28 x,BIG_384_28 y,BIG_384_28 n);
...
*/
extern void BIG_384_28_mod2m(BIG_384_28 x,int m);
...
static inline chunk muladd_384_28(chunk x,chunk y,chunk c,chunk *r)
{
    dchunk prod=(dchunk)x*y+c+*r;
    *r=(chunk)prod&BMASK_384_28;
    return (chunk)(prod>>BASEBITS_384_28);
}

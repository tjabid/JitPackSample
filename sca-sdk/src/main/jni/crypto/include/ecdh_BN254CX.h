...
#define EGS_BN254CX MODBYTES_256_56  /**< ECC Group Size in bytes */
#define EFS_BN254CX MODBYTES_256_56  /**< ECC Field Size in bytes */
 ...
 *
	...
	@return 0 or an error code
 */
extern int ECP_BN254CX_SVDP_DH(octet *s,octet *W,octet *K);

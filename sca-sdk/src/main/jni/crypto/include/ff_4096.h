 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_4096_mod(BIG_512_60 *x,BIG_512_60 *m,int n);
/**	@brief Square an FF
 *
	Uses Karatsuba method internally
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_4096_skpow(BIG_512_60 *r,BIG_512_60 *x,BIG_512_60 * e,BIG_512_60 *m,int n);
/**	@brief Calculate r=x^e mod m, side channel resistant
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_4096_skspow(BIG_512_60 *r,BIG_512_60 *x,BIG_512_60 e,BIG_512_60 *m,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_4096_power(BIG_512_60 *r,BIG_512_60 *x,int e,BIG_512_60 *m,int n);
/**	@brief Calculate r=x^e mod m
 *
	@param r FF instance, on exit = x^e mod p
	@param x FF instance
	...
	@param n size of FF in BIGs
 */
extern void FF_4096_pow(BIG_512_60 *r,BIG_512_60 *x,BIG_512_60 *e,BIG_512_60 *m,int n);
